...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"AlphaLongitudinalEnabled",
     {PERSISTENT | DEVELOPMENT_ONLY | BACKUP, BOOL}},
    ...
    {"BlinkerMinLateralControlSpeed",
     {PERSISTENT | BACKUP, INT, "20"}}, // MPH or km/h
    {"BlinkerPauseLateralControl", {PERSISTENT | BACKUP, INT, "0"}},
    {"Brightness", {PERSISTENT | BACKUP, INT, "0"}},
    {"CarParamsSP",
     {CLEAR_ON_MANAGER_START | CLEAR_ON_ONROAD_TRANSITION, BYTES}},
    ...
    {"SentryMode", {PERSISTENT | BACKUP, BOOL, "0"}},
    ...
    {"ModelManager_DownloadIndex",
     {CLEAR_ON_MANAGER_START | CLEAR_ON_ONROAD_TRANSITION, INT, "0"}},
    {"ModelManager_Favs", {PERSISTENT | BACKUP, STRING}},
    {"ModelManager_LastSyncTime",
     {CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION, INT, "0"}},
    ...
    {"SunnylinkTempFault",
     {CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION, BOOL, "0"}},
    ...
    {"OsmDbUpdatesCheck",
     {CLEAR_ON_MANAGER_START,
      BOOL}}, // mapd database update happens with device ON, reset on boot
    ...
    {"TorqueParamsOverrideKp", {PERSISTENT | BACKUP, FLOAT, "10.0"}},
    {"TorqueParamsOverrideKi", {PERSISTENT | BACKUP, FLOAT, "5.0"}},
    {"TorqueParamsOverrideKf", {PERSISTENT | BACKUP, FLOAT, "0.0"}},
    {"TorqueParamsOverrideDeadzone", {PERSISTENT | BACKUP, FLOAT, "0.0"}},
    {"LiveTuningEnabled", {PERSISTENT | BACKUP, BOOL, "0"}},
};
